...
/**
 * @see [MaterialDialog.selectedFolder]
 */
fun MaterialDialogWrapper.selectedFolder() = dialog.selectedFolder()

/**
 * @see [MaterialDialog.folderChooser]
 */
fun MaterialDialogWrapper.folderChooser(options: FileFolderPickerOptions) {
    dialog.folderChooser(context = options.context,
